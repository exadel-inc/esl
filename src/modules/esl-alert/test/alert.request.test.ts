...
import type {AlertActionParams} from '../core/esl-alert';
...
describe('ESLAlert: events', () => {
  ...
  test('Show/Hide events ', () => {
    ESLEventUtils.dispatch($el, ESLAlert.prototype.SHOW_REQUEST_EVENT);
  ...
  test('Add text params', () => {
    const params: CustomEventInit<AlertActionParams> = {detail: {text: 'esl-alert-text'}};
    ESLEventUtils.dispatch($el, ESLAlert.prototype.SHOW_REQUEST_EVENT, params);
