...
export const twitter: ESLShareButtonConfig = {
  action: 'media',
  icon: '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 28 28"><path d="M20.2,4.3h3.3l-7.2,8.3l8.5,11.2h-6.7L13,16.9l-6,6.8H3.7l7.7-8.8L3.3,4.3h6.8l4.7,6.2L20.2,4.3z M19.1,21.8 h1.8L9.1,6.1h-2L19.1,21.8z" fill="#fff"/></svg>',
  iconBackground: '#000',
