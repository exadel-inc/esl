...
describe('ESLCarousel: Utils', () => {
  ...
  describe('toIndex', () => {
    test.each([
      [0, {count: 5, activeCount: 1, firstIndex: 2}, 0],
      [1, {count: 5, activeCount: 2, firstIndex: 2}, 1],
      [5, {count: 5, activeCount: 1, firstIndex: 0}, 0],
      [6, {count: 5, activeCount: 3, firstIndex: 1}, 1],

      ['-1', {count: 5, activeCount: 1, firstIndex: 2}, 1],
      ['+1', {count: 5, activeCount: 2, firstIndex: 2}, 3],
      ['-3', {count: 5, activeCount: 1, firstIndex: 2}, 4],
      ['+3', {count: 5, activeCount: 3, firstIndex: 2}, 0],
      ...
      ['next', {count: 5, activeCount: 1, firstIndex: 2}, 3],
      ['next', {count: 5, activeCount: 2, firstIndex: 2}, 3],
      ['next', {count: 5, activeCount: 1, firstIndex: 4}, 0],
      ['next', {count: 5, activeCount: 2, firstIndex: 4}, 1],
      ['next', {count: 5, activeCount: 3, firstIndex: 0}, 2],

      ['prev', {count: 5, activeCount: 1, firstIndex: 2}, 1],
      ['prev', {count: 5, activeCount: 2, firstIndex: 2}, 0],
      ['prev', {count: 5, activeCount: 1, firstIndex: 0}, 4],
      ['prev', {count: 5, activeCount: 3, firstIndex: 1}, 0],
      ['prev', {count: 5, activeCount: 3, firstIndex: 4}, 1],
    ])(
      '(target = %s, cfg = %p) = %d',
