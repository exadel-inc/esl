...
describe('ESLCarousel: Nav Utils', () => {
  ...
  //     test.each([
  //       [0, {count: 2, size: 5, activeIndex: 0}, 0],
  //       [1, {count: 2, size: 5, activeIndex: 0}, 1],
  //       [5, {count: 2, size: 5, activeIndex: 0}, 0],
  //       [6, {count: 2, size: 5, activeIndex: 0}, 1],
  //       ['2', {count: 2, size: 5, activeIndex: 0}, 2]
  //     ])(
  //       '(index = %d, %o) => %d',
  ...
  //     test.each([
  //       ['-1', {count: 2, size: 5, activeIndex: 2}, 1],
  //       ['+1', {count: 2, size: 5, activeIndex: 2}, 3],
  //       ['-3', {count: 2, size: 5, activeIndex: 2}, 4],
  //       ['+3', {count: 2, size: 5, activeIndex: 2}, 0]
  //     ])(
  ...
  describe('toIndex', () => {
    describe('numeric input', () => {
      test.each([
        ...
        [5, {size: 5, count: 1, activeIndex: 0}, 0],
        [6, {size: 5, count: 3, activeIndex: 1}, 1]
      ])(
        '(target = %s, cfg = %p) = %d',
    ...
    describe('relative slide target', () => {
      test.each([
        ...
        ['-3', {size: 5, count: 1, activeIndex: 2}, 4],
        ['+3', {size: 5, count: 3, activeIndex: 2}, 0]
      ])(
        '(target = %s, cfg = %p) = %d',
        (target: ESLCarouselSlideTarget, cfg: ESLCarouselState, result: number) => expect(toIndex(target, cfg).index).toBe(result)
      );
    ...
    describe('slide target relative full', () => {
      test.each([
        ...
        ['slide:-3', {size: 5, count: 1, activeIndex: 2}, 4],
        ['slide:+3', {size: 5, count: 3, activeIndex: 2}, 0]
      ])(
        '(target = %s, cfg = %p) = %d',
        (target: ESLCarouselSlideTarget, cfg: ESLCarouselState, result: number) => expect(toIndex(target, cfg).index).toBe(result)
      );
