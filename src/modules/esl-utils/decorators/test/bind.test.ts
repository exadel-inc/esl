...
describe('Common @bind decorator test', () => {
  describe('Basic binding tests', () => {
    ...
    test('Decorated method accessed from instance has bound context', () =>
      expect(instance1.getThis.call(null)).toBe(instance1));
    test('Decorated method second access from instance has bound context', () =>
      expect(instance1.getThis.call(null)).toBe(instance1));
    test('Decorated method from another instance bound correctly', () =>
      expect(instance2.getThis.call(null)).toBe(instance2));

    test('Bounded methods accessing uses cache to return the same function instance', () =>
      expect(instance1.getThis).toBe(instance1.getThis));
    test('Bounded methods accessing should not return bounded function of another instance', () =>
  ...
  describe('Basic context test', () => {
    ...
    test('Context of bounded method saved if method called outside ', () => {
  ...
  describe('Inheritance basic binding test', () => {
    ...
    test('Instance of inherited class has bounded method', () =>
      expect(instance.getThis.call(null)).toBe(instance));
    test('Inherited bounded method saves context on the second call', () =>
      expect(instance.getThis.call(null)).toBe(instance));
    test('Accessing bound inherited method returns the same method instance', () =>
  ...
  describe('Prototype access should return original method', () => {
    ...
    const instance1 = new Test();
    test('Prototype method direct call uses undecorated method', () =>
      expect(Test.prototype.getThis.call(instance1)).toBe(instance1));

    const instance2 = new Test();
    test('Attempt to call prototype method second time still respects the context', () =>
  ...
  describe('Inheritance super keyword should return original method', () => {
    ...
    const instance = new TestChild();
    test('Method override can access super method definition', () =>
      expect(instance.getThisName()).toBe('Hello world'));
    test('Overridden method accessing super method definition, itself bound correctly', () =>
      expect(instance.getThisName()).toBe('Hello world'));
    test('Other methods can access parent class method definition', () =>
      expect(instance.getThisSuperName()).toBe('Hello'));

    const instance2 = new TestChild();
    instance2.postfix = '!';

    test('Instances accessing superclass methods use correct context', () =>
      expect(instance2.getThisName()).toBe('Hello! world'));

    const instance3 = new TestChild();
    test('Instances accessing superclass methods use exact unbounded version from prototype', () =>
