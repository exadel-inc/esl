...
var ESLTabs = /** @class */ (function (_super) {
    ...
    ESLTabs.prototype.bindScrollableEvents = function () {
        ...
        (_a = this.$container) === null || _a === void 0 ? void 0 : _a.addEventListener('scroll', this._onScroll, { passive: true });
    ...
    ESLTabs.prototype.unbindScrollableEvents = function () {
        ...
        (_a = this.$container) === null || _a === void 0 ? void 0 : _a.removeEventListener('scroll', this._onScroll);
    ...
    ESLTabs.prototype.updateArrows = function () {
        ...
        if (!$container)
            return;
        var hasScroll = $container.scrollWidth > this.clientWidth;
        ...
        var scrollStart = Math.abs($container.scrollLeft) > 1;
        var scrollEnd = Math.abs($container.scrollLeft) + $container.clientWidth + 1 < $container.scrollWidth;
    ...
    ESLTabs.is = 'esl-tabs';
    __decorate([
        (0,_esl_base_element_core__WEBPACK_IMPORTED_MODULE_3__.attr)({ defaultValue: '.esl-tab-container' })
    ], ESLTabs.prototype, "container", void 0);
    __decorate([
        (0,_esl_base_element_core__WEBPACK_IMPORTED_MODULE_4__.boolAttr)()
