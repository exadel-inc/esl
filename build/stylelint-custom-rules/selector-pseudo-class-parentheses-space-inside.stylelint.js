...
/**
 * Custom StyleLint plugin to require a single space or disallow whitespace
 * on the inside of the parentheses within pseudo-class selectors.
 */
...
const ruleName = 'esl-less/selector-pseudo-class-parentheses-space-inside';
