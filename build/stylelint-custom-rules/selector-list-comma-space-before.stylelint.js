'use strict';
/**
 * Custom StyleLint plugin to require a single space or disallow whitespace before the commas of selector lists.
 */
...
const ruleName = 'esl-less/selector-list-comma-space-before';
