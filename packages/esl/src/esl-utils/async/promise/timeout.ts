/** @returns Promise that will be resolved or rejected in `timeout` */
...
export function promisifyTimeout<T>(timeout: number, payload?: T, isReject?: boolean): Promise<T | undefined> {
