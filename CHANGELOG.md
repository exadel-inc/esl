...
- ⚠️  **esl-media:** migrate module styles to pure CSS export ([c59b8948b](https://github.com/exadel-inc/esl/commit/c59b8948b))
- **eslint-config:** add `consistent-type-imports` to codestyle rules ([3387cdefa](https://github.com/exadel-inc/esl/commit/3387cdefa))
...
- **esl-media:** migrate module styles to pure CSS export  ([c59b8948b](https://github.com/exadel-inc/esl/commit/c59b8948b))
  `esl-media` styles are now exported as pure CSS. Use `@exadel/esl/modules/esl-media/core.css` instead of LESS mixins/imports (`core.mixin.less`, `core.less`).
...
- ⚠️  **esl-popup:** esl-popup no longer support LESS mixin-builder for styles ([420ad6faa](https://github.com/exadel-inc/esl/commit/420ad6faa))
...
- **esl-popup:** esl-popup no longer support LESS mixin-builder for styles  ([420ad6faa](https://github.com/exadel-inc/esl/commit/420ad6faa))
  `esl-popup/core.mixin.less` no longer available use CSS variable based customisation
...
- **site:** add documentation for website monitoring ([6e0b63c3c](https://github.com/exadel-inc/esl/commit/6e0b63c3c))
- **site:** update documentation for website monitoring ([cf5bdb297](https://github.com/exadel-inc/esl/commit/cf5bdb297))
